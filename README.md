...
Generated from the SpatioAPI OpenAPI spec on every release. PRs against generated files will be overwritten on the next release; file issues at https://github.com/spatio-labs/spatio-swift/issues for bugs in the SDK shape.
